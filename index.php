...
<body class="horizontal-layout horizontal-menu 2-columns navbar-floating footer-static ecommerce-application "
    ...
    <!-- BEGIN: Header-->
    <nav class="header-navbar navbar-expand-lg navbar navbar-with-menu navbar-fixed shadow-none navbar-brand-center">
                        ...
                        <ul class="nav navbar-nav bookmark-icons">
                            <li class="nav-item d-none d-lg-block text-bold-700">
                                <a href="#login" class="btn">
                                    <img src="w/img/toko/logo-h.png" width="100" />
                                    <!-- <?= $a['logo-h'] ?> MASUKKAN LOGO-H DI DATABASE DULU -->
                                </a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="card text-center">
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <h2 class="counter text-bold-700">20</h2>
                ...
                <section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 p-5 text-center">
                            <h3 class="display-5">Layanan Konsumen : 0898-7818-126<br> admin@santrimart.id</h3>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix blue-grey lighten-2 mb-0">
            <span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy;
                <?php echo date('Y') ?>
                <a class="text-bold-800 grey darken-2" href="#" target="_blank">santrimart.id,</a>
                All rights Reserved
            </span>
            <span class="float-md-right d-none d-md-block">Santrimart 
                <img src="w/logo.png" width="30" />
            </span>

                ...
                <div class="form-group breadcrum-right">
                    <div class="dropdown">
                        <div class="badge badge-primary float-right">
                            ...
                            $sql_user = mysqli_query($koneksi, "SELECT * FROM tabel_barang WHERE kd_kategori = '$kd_kategori'");
            ...
            <div class="content-body">
                ...
                <section id="basic-examples">
                    <div class="row match-height">
                        ...
                        $previous = $halaman - 1;
                        $next = $halaman + 1;
                        $data = mysqli_query($koneksi, "SELECT * FROM tabel_barang,tabel_barang_gambar,tabel_stok_toko WHERE tabel_barang.kd_barang = tabel_barang_gambar.id_brg AND tabel_barang.kd_barang = tabel_stok_toko.kd_barang AND tabel_barang.kd_kategori = '$kd_kategori'");
                        $jumlah_data = mysqli_num_rows($data);
                        $total_halaman = ceil($jumlah_data / $batas);
                        $data_barang = mysqli_query($koneksi, "SELECT * FROM tabel_barang,tabel_barang_gambar,tabel_stok_toko WHERE tabel_barang.kd_barang = tabel_barang_gambar.id_brg AND tabel_barang.kd_barang = tabel_stok_toko.kd_barang AND tabel_barang.kd_kategori = '$kd_kategori' limit $halaman_awal, $batas");
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="btn-group d-xl-block d-none justify-content-between mt-2 m-0 p-0">
                                            ...
                                            <a href="index.php?menu=checkout&kd_barang=<?php echo $d['kd_barang']; ?>"
                                                class="btn btn-warning rounded-0"><i class="fas fa-shopping-cart"></i>
                                                Beli</a>
                                        </div>
                        ...
                        <div class="col-sm-12">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center mt-2">
                                    <li class="page-item prev-item"><a class="page-link" <?php if ($halaman > 1) {

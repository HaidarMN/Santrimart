                                    ...
                                    <div class="card rounded-0 mb-0 p-1">
                                        ...
                                        <div class="card-content">
                                          <ul class="nav nav-tabs justify-content-center" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link btn btn-sm font-small-1" id="home-tab-center" data-toggle="tab" href="#home-center" aria-controls="home-center" role="tab" aria-selected="true">Merchant (Penyedia layanan)</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link btn btn-sm font-small-1 bg-info" id="service-tab-center" data-toggle="tab" href="#service-center" aria-controls="service-center" role="tab" aria-selected="false">User (Pengguna)</a>
                                            </li>
                                          </ul>
                                        </div>

                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form  action="" method="POST">
                                                    ...
                                                    <button type="submit" name="submit" class="btn btn-sm btn-primary float-right btn-inline mb-50">Ganti Password</button>
                                                ...
                                                <div class="carousel-inner" role="listbox">
                                                    ...
                                                    ?>
                                                        <div class="carousel-item active">
                                                            ...
                                                            // print_r($a)
                                                            ?>
                                                            <img class=" mb-0 pb-0 card-img mb-2" src="../img/produk/<?php echo $e[0]; ?>" style="width:480px !important; height:480px !important;">
                                                    ...
                                                    ?>
                                                        <div class="carousel-item">
                                                            ...
                                                            <img class="card-img mb-0 pb-0" src="../img/produk/<?php echo $c[0]; ?>">
                                                            <p class="card-text"><?php echo $toko; ?> </p>
                                                            <hr class="my-0">
                                                            <div class="justify-content-between mt-0">
                                                                <div class="float-left">

	...
	if($pass == $password1){
		...
		if($akses == 'merchant'){
			...
			$query = "INSERT INTO `tabel_member`
						(`kode_user`, `nm_user`, `email_user`,`alamat_user`, `password`,`pass_user`,`hp`,`akses`,`stt_user`) 
					VALUES 
						('$random', '$nama', '$email','$alamat','$passmd','$password1','$no_tlv','$akses','$status')";
		}
		else if($akses == 'member'){
			$query = "INSERT INTO `tabel_member`
						(`kode_user`, `nm_user`, `email_user`,`alamat_user`, `password`,`pass_user`,`hp`,`akses`,`stt_user`) 
					VALUES 
						('$random', '$nama', '$email','$alamat','$passmd','$password1','$no_tlv','$akses','0')";
		}

...
if (isset($_POST['upload_edit_toko'])) {
    ...
    $konten = $_POST['konten'];
    if (!$konten) {
        echo "<script>alert('Konten toko kosong');history.back()</script>";
        return false;
    }
    ...
    if ($_FILES['header']['name'] != null) {
        ...
        $query_tabel_toko = "UPDATE `tabel_toko` SET `nm_toko`='$nama_toko',`almt_toko`='$alamat',`kota_toko`='$kota',`kecamatan_toko`='$kecamatan',`logo_header`='$header_name_new',`headerfooter`='$style_headerfooter',`background`='$style_background',`tombol`='$style_tombol', `konten`='$konten',`ketentuan`='$ketentuan' WHERE `kd_toko` = '$id'";
    } else {
        $query_tabel_toko = "UPDATE `tabel_toko` SET `nm_toko`='$nama_toko',`almt_toko`='$alamat',`kota_toko`='$kota',`kecamatan_toko`='$kecamatan',`headerfooter`='$style_headerfooter',`background`='$style_background',`tombol`='$style_tombol', `konten`='$konten', `ketentuan`='$ketentuan' WHERE `kd_toko` = '$id'";
    }
    ...
    if ($_FILES['image']['name'] != null) {
        ...
        $query_tabel_toko = "UPDATE `tabel_toko` SET `nm_toko`='$nama_toko',`almt_toko`='$alamat',`kota_toko`='$kota',`kecamatan_toko`='$kecamatan',`logo`='$image_name_new',`headerfooter`='$style_headerfooter',`background`='$style_background',`tombol`='$style_tombol', `konten`='$konten', `ketentuan`='$ketentuan' WHERE `kd_toko` = '$id'";
    } else {
        $query_tabel_toko = "UPDATE `tabel_toko` SET `nm_toko`='$nama_toko',`almt_toko`='$alamat',`kota_toko`='$kota',`kecamatan_toko`='$kecamatan',`logo_header`='$header_name_new',`headerfooter`='$style_headerfooter',`background`='$style_background',`tombol`='$style_tombol', `konten`='$konten',`ketentuan`='$ketentuan' WHERE `kd_toko` = '$id'";
    }

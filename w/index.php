            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        <li class="nav-item nav"><a href="#" class="btn btn-dark mt-1 mb-1 font-small-3"><i
                                    class="fab fa-google-play"></i> Download App!</a></li>
                        <li class="dropdown dropdown-user nav-item"><a
                                class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav"><span class="user-name text-bold-300 text-white">Akses APP!</span><span
                                        class="user-status text-bold-600 text-white">Now!</span></div>
                                <i class="ficon fas fa-shopping-cart d-lg-none"></i>
        ...
        <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-without-dd-arrow navbar-shadow menu-border"
            ...
            <div class="navbar-container main-menu-content" data-menu="menu-container">
                <ul class="nav navbar-nav justify-content-center" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#akses"><i class="fas fa-user-lock"></i> Akses
                            APP!</a></li>
                    <li class="nav-item"><a class="nav-link" href="#contact_us"><i class="fas fa-headset"></i> Contact
                            Us</a></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="card bg-transparent shadow-none">
                            <div class="divider">
                                <div class="divider-text">
                                    <h3 class="mb-3 display-4 pt-2 text-uppercase">Cek Produk disini</h3>
                                </div>
                            </div>
   ...
   <div class="content-body">
    <div class="row justify-content-center">
      <div class="col-md-12 text-center">
         <div class="divider">
            <div class="divider-text"><h3 class="mb-3 display-5 pt-2 text-uppercase">Banyak Gratisnya</h3></div>
          </div>
      </div>
    </div>
    <div class="card-content">
                ...
                <div class="content-body">
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center">
                            <div class="divider">
                                <div class="divider-text">
                                    <h3 class="mb-3 display-5 pt-2 text-uppercase">Akses APP!</h3>
                                </div>
                            </div>
                        </div>
                    </div>
